...
SECRET_KEY = '$irmpq9tf3u0qvkp3iez^-@c_=d+6p1ew8p38%j(%!#@zq05dh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'dashboard/dist/dashboard')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'accounts.rest_backend.JSONWebTokenAuthenticationBackend',
